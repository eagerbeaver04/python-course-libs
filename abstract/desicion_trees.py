...
# Формула заранее неизвестна.
# СЛ - пример ансамблевого метода, основанного на агрегации множества простых моделей.

# В реализациях дерева принятия решений в машинном обучении вопросы обычно
# ведут к разделению данных по осям. Каждый узел разбивает данные на две
# группы по одному из признаков.
