...
# Языковая модель позволяет предсказывать следующее слово, зная предыдущие.
# Метки не требуются, но нужно очень много текста.
...
with open('C:/.fastai/data/human_numbers/train.txt') as f:
    lines += L(*f.readlines())
